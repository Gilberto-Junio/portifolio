...
function Contact() {
  return (
    <div id="contactcontent" className="flex flex-wrap justify-center w-full px-14 py-7 bg-gray-300 dark:bg-gray-800 sm:rounded-md transition-all">
        <p className="flex justify-center w-full text-2xl text-red-400 font-bold mb-5">
            Contatos
        </p>
        <div className="flex flex-row flex-wrap justify-between">
            <a 
                href="https://web.whatsapp.com/send?phone=5511968208871" 
                className="flex flex-row m-5 text-xl items-center space-x-3 hover:text-red-400 hover:scale-105 transition-all"
                target="_blank"
            >
                <FaWhatsapp className="text-3xl text-red-400"/>
            ...
            <a 
                ...
                target="_blank"
            >
                <IoIosMail className="text-3xl text-red-400"/>
                <p className="font-semibold">
            ...
            <a 
                ...
                target="_blank"
            >
                <FaLinkedin className="text-3xl text-red-400"/>
                <p className="font-semibold">
                    Gilberto Junio
                </p>
            </a>
            <a 
                ...
                target="_blank"
            >
                <FaMapLocationDot className="text-3xl text-red-400"/>
                <p className="font-semibold">
